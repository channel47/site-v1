...
export const FAQS: Faq[] = [
  ...
  },
  {
    ...
    answer:
      'Yes. Members get the code <span class="mono" style="font-size:13px;color:#cc4b1e">VIBE47</span>, which unlocks the entire library here for free and discounts the studio rate. I build each system live in the monthly lab — you watch it get made, then take it home. <a href="{joinUrl}" target="_blank" rel="noopener" class="ul" style="color:#cc4b1e">Join here →</a>',
  },
  {
