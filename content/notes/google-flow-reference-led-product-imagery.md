...
1. Pick two reference images because their lighting and composition feel right.
2. Ask the Flow agent to describe what those images are doing visually, and tell it you want that direction for the brand.
3. Add real product photos in the same conversation.
4. Let the agent explore, then inspect packaging, labels, and colors before anything ships.
